...
public class MailSenderService {
	...
	public int sendStore(Store store) {
		...
		try {
			...
			html += "<a href=\"http://localhost:8080/BangBang/store\">방방술래 가맹점 페이지 바로가기</a> <br>";
			...
			// to : 받는 사람의 이메일 설정
			message.addRecipient(RecipientType.TO, new InternetAddress(store.getOemail(), store.getOname() + "님", "utf-8"));
